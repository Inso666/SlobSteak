...
| ID | Titel | Bounded Context | Abhängigkeiten | Datei | Status |
|---|---|---|---|---|---|
| US-069 | Assessment-Inhalt des standardmäßig aktiven Tabs zuverlässig bei Erstaufruf rendern | StakeholderAssessment | US-029, US-030, US-059 | [US-069-assessment-tabs-markforcheck.md](US-069-assessment-tabs-markforcheck.md) | offen |
