...
| US-058 | Zoneless-Reaktivität systematisch nachziehen (fehlendes `markForCheck()` in weiteren `subscribe()`-Callbacks) | Frontend-Shell | US-050, US-057 | [US-058-zoneless-reaktivitaet-systematisch-nachziehen.md](US-058-zoneless-reaktivitaet-systematisch-nachziehen.md) | offen |
