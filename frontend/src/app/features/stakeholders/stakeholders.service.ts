...
/**
 * Injizierbarer Service für Stakeholder-Stammdaten (US-021). Alle HTTP-Zugriffe laufen
...
export class StakeholdersService {
  ...
  createStakeholder(projectId: string, payload: CreateStakeholderPayload): Observable<Stakeholder> {
